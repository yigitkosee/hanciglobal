...
const UI_STRINGS = {
  en: {
    ...
    noSmoking: "No smoking", noParties: "No parties or events", petsNote: "Pets not allowed", quietHours: "Quiet hours 12 AM – 8 AM",
    ...
    night: "night", nights: "nights", totalForStay: "total for stay", priceOnRequest: "Price on request",
    perNightSuffix: "/ night", bookingSub: "Price varies by season and length of stay", bookingNote: "Booking direct means no platform fees — same apartment, better price.",
  ...
  tr: {
    ...
    noSmoking: "Sigara içilmez", noParties: "Parti / etkinlik yapılmaz", petsNote: "Evcil hayvan kabul edilmez", quietHours: "Sessiz saatler 00:00 – 08:00",
    ...
    night: "gece", nights: "gece", totalForStay: "toplam", priceOnRequest: "Fiyat için sorunuz",
    perNightSuffix: "/ gece", bookingSub: "Fiyat sezona ve konaklama süresine göre değişir", bookingNote: "Direkt rezervasyon, platform ücreti olmadığı anlamına gelir — aynı daire, daha iyi fiyat.",
  ...
  ru: {
    ...
    noSmoking: "Курение запрещено", noParties: "Вечеринки запрещены", petsNote: "Животные не допускаются", quietHours: "Тихие часы 00:00 – 08:00",
    ...
    night: "ночь", nights: "ночей", totalForStay: "итого за проживание", priceOnRequest: "Цена по запросу",
    perNightSuffix: "/ ночь", bookingSub: "Цена зависит от сезона и продолжительности проживания", bookingNote: "Прямое бронирование означает отсутствие комиссии платформы — те же апартаменты, лучшая цена.",
