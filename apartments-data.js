...
const UI_STRINGS = {
  en: {
    ...
    showAll: "Show all", amenitiesWord: "amenities", reviewsWord: "reviews", locationTitle: "Where you'll be", showMore: "Show more", showLess: "Show less",
  ...
  tr: {
    ...
    showAll: "Tümünü göster", amenitiesWord: "olanak", reviewsWord: "değerlendirme", locationTitle: "Konum", showMore: "Devamını göster", showLess: "Daha az göster",
  ...
  ru: {
    ...
    showAll: "Показать все", amenitiesWord: "удобств", reviewsWord: "отзывов", locationTitle: "Расположение", showMore: "Показать больше", showLess: "Показать меньше",
...
const STAY_PAGE = {
  en: {
    ...
    viewAirbnb: "🏠 View on Airbnb", bookDirect: "💬 Book direct", getDirections: "📍 Get directions",
  ...
  tr: {
    ...
    bedroomsWord: "yatak odası", guestsUpTo: "", guestsWord: "kişiye kadar", fromWord: "", perNight: "/ gece",
    viewAirbnb: "🏠 Airbnb'de gör", bookDirect: "💬 Direkt rezervasyon", getDirections: "📍 Yol tarifi al",
  ...
  ru: {
    ...
    viewAirbnb: "🏠 Смотреть на Airbnb", bookDirect: "💬 Прямое бронирование", getDirections: "📍 Как добраться",
